...
impl SignScheme for SimpleParameters {
	...
	println!("YINGYING simply signning allows_image 1");
	...
	println!("YINGYING simply signning allows_image 2");
	...
	println!("YINGYING simply signning allows_image 3");
	...
	println!("YINGYING simply signning allows_image 4");
 
        if reject_reasons.is_empty() {
            reject_reasons.push(anyhow!("Can not find any signatures."));
        }
	println!("YINGYING simply signning allows_image 6");
