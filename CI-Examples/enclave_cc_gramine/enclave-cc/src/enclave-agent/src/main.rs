...
const CONTAINER_BASE: &str = "/tmp/run/enclave-cc-containers";
const CC_IMAGE_WORK_DIR: &str = "/tmp/run/image/";
...
impl ImageService {
    fn new() -> Self {
        ...
        let new_config = ImageConfig {
            default_snapshot: snapshots::SnapshotType::Graminefs/*OcclumUnionfs*/,
            ..Default::default()
        };
        Self {
